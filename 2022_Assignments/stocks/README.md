...
<!--
Describe each module in the project, what their purpose is and how they are used in your program. Try to aim for at least 150 words per module.
-->
...
- How a developer can add new order types.
- How a developer can add new trade strategies.

Use as many words you need to clearly explain the above.
-->
